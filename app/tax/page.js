    ...
    <Suspense fallback={<LoaderComponent />}>
      ...
      {CreditNewsList && (
        <div className='bg-[#F4F8FB] h-auto'>
          <CommonBreadCrumbComponent link1='/tax' link1Name='Tax' link2Name='News' title='Tax Blogs' />
          <CreditNews CreditNewsList={CreditNewsList} pageTitle='Tax Blogs' taxPage={true} />
        </div>
      )}
